...
describe "Merchants API" do
  describe "CRUD Functionality" do
    describe "happy paths" do 
      it "sends a list of all merchants" do
        ...
        expect(merchants).to_not have_key(:error)
  ...
  describe "merchant items search" do
    ...
    it "can display a 404 if a merchant has no items " do
      ...
      expect(error_data).to_not have_key(:data)
      expect(error_data[:error]).to eq('No item found')
    end
  end

  describe "Unrestful routes and search query params" do
